...
public final class StringUtils {
	 ...
	 */
	public static int levenshteinDistance(CharSequence lhs, CharSequence rhs) throws LevenshteinException 
	{
		if(lhs == null || rhs == null)
		{
			throw new LevenshteinException("On ne peut pas passer de paramètre null");
		}
